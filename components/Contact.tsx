  ...
  return (
    <main id="contact" className="bg-gray-50 py-14 sm:py-16 px-4 sm:px-5">
      ...
      <div className="flex flex-col items-center justify-center gap-2 mb-12 sm:mb-16">
        ...
        <h1 className="text-[clamp(2.25rem,7vw,4rem)] leading-[1.05] text-center tracking-tight my-3 text-slate-900">
          Let's create <br />
        ...
        <p className="text-base sm:text-lg text-center leading-relaxed text-slate-700 max-w-xl sm:max-w-2xl">
      ...
      <section className="max-w-[1400px] mx-auto px-0 sm:px-5 grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
        ...
        <div className="bg-white rounded-lg p-5 sm:p-8 border border-gray-200 lg:col-span-2">
